...
CREATE TABLE `Customizable` (
    ...
    `opción_a` VARCHAR(191) NOT NULL,
    `opción_b` VARCHAR(191) NOT NULL,
    `opción_c` VARCHAR(191) NOT NULL,
    `opción_d` VARCHAR(191) NOT NULL,
    `correcta` VARCHAR(191) NOT NULL,
    `puntuación` INTEGER NOT NULL DEFAULT 10,
    `explicación` VARCHAR(191) NULL,
